...
//              Text(UIData.appName)
  ...
  void _showModalBottomSheet(BuildContext context, Menu menu) {
    ...
    // If there are no items in the list, go directly to the menu indicted in the menu title
    if (menu.items.length < 1){
      Navigator.pushNamed(
          context, "/${menu.title}");
    }

    // If there are items in the menu list (A.k.a. there are sub-items in the list...)
    // Display them with showModalBottomSheet
    else{
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, i) => Padding(
                            ...
                            child: ListTile(
                                ...
                                onTap: () {
                                  Navigator.pop(context);           // We need to pop the context here to
                                                                    // get out of the ModalBottomSheet context!
                                  Navigator.pushNamed(
