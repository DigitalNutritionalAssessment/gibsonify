...
class SensitisationVisitDataCard extends StatefulWidget {
  ...
  @override
  _SensitisationVisitDataCardState createState() => _SensitisationVisitDataCardState();
}

class _SensitisationVisitDataCardState extends State<SensitisationVisitDataCard> {
...
//  ValueChanged<InterviewData> updatePageState;
  ...
  void initState(){
    ...
    if (widget.saveConsumptionData != null) saveConsumptionData = widget.saveConsumptionData;
...
//    interviewData.enumerator.employeeNumber = _prefs.getInt("employeeName");
      ...
      interviewData.location.locationName = await InterviewData.getLocationFromSharedPrefs();
...
//                    ),
                    TimePicker(
                      initialTime: interviewData?.sensitizationVisitDate ?? null,
                      onChanged: (time) {
